...
class Listify_WP_Job_Manager_Template extends listify_Integration {
    ...
    ?>
        <div class="content-single-job_listing-title-category">
            <?php if ( $types ) : ?>
              <?php
                $types = str_replace("CEL", "Course en Ligne", $types);
                $types = str_replace("DRB", "Dragon Boat", $types);
                $types = str_replace("KAP", "Kayak-Polo", $types);
                $types = str_replace("MAN", "Multi-activités nautiques", $types);
                $types = str_replace("MAR", "Marathon", $types);
                $types = str_replace("REC", "Randonnée en eau calme", $types);
                $types = str_replace("REV", "Randonnée en eau vive", $types);
                $types = str_replace("DES", "Descente", $types);
                $types = str_replace("KHR", "Kayak haute rivière", $types);
                $types = str_replace("NEV", "Nage en eau vive", $types);
                $types = str_replace("RAF", "Raft", $types);
                $types = str_replace("FRE", "Freestyle", $types);
                $types = str_replace("SLA", "Slalom", $types);
                $types = str_replace("REM", "Randonnée en mer", $types);
                $types = str_replace("OCR", "Ocean-Racing / Va'a", $types);
                $types = str_replace("VAA", "Va'a", $types);
                $types = str_replace("WAS", "Waveski-Surfing", $types);
                $types = str_replace("VAV", "Va'a Vitesse", $types);
                $types = str_replace("PAR", "Paracanoë", $types);
                $types = str_replace("MSR", "Multisports et Raids", $types);
              ?>
              <?php echo $types; ?>
              <!-- <span class="ion-chevron-right"></span> -->
            <?php endif; ?>
    ...
    public function job_types_label() {
        ...
        _e( 'Activités proposées :', 'listify' );
        echo '</p>';
    }
