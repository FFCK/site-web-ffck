...
class WP_Job_Manager_Job_Tags_Shortcodes {
	...
	public function show_tag_filter( $shortcode_atts ) {
		...
		echo '<a href="#" id="adfilter">Recherche avancée</a><div class="filter_wide filter_by_tag">' .  __( 'Accueil de personnes en situation de handicap :', 'wp-job-manager-tags' ) . ' <span class="filter_by_tag_cloud"></span></div>';
	}
	...
	public function job_manager_get_listings_result( $results ) {
      ...
      $html = str_replace("HAN-MOT", "Moteur", $html);
      $html = str_replace("HAN-MEN", "Mental", $html);
      $html = str_replace("HAN-AUD", "Auditif", $html);
      $html = str_replace("HAN-VIS", "Visuel", $html);
