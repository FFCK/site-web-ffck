jQuery( document ).ready( function ( $ ) {
	...
	$( '.job_listings' ).on( 'update_results', function ( event, page, append, loading_previous ) {
		...
		if ( $('input[name="search_location"]').val() != "" ) {
			xhr[index] = $.ajax( {
				type: 'POST',
			...
			$( results ).removeClass( 'loading' );
			$('.update_results').removeAttr('data-refresh');
			$('.update_results').removeClass('refreshing');
			$('.update_results').html('Entrer une localisation');
		}
	} );
