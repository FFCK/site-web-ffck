...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_location">
			<label for="search_location"><?php _e( 'Localisation', 'wp-job-manager' ); ?></label>
			<input type="text" name="search_location" id="search_location" placeholder="<?php esc_attr_e( 'Localisation', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $location ); ?>" />
		</div>
