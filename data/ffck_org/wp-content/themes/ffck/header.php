...
<head>
  ...
  <link href="<?php echo get_template_directory_uri(); ?>/css/jquery.fb.albumbrowser.css" rel="stylesheet">
         ...
         <div class="header_right">
           <div class="header_top">
             <div class="top_nav">
                               ...
                               ?>
                               <div class="h_social">
                                 <a href="<?php echo $fb_link; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png"  alt=""></a>
                                 <a href="<?php echo $tw_link; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png"  alt=""></a>
                                 <a href="<?php echo $in_link; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/instagram.png"  alt=""></a>
                                 <a href="<?php echo $pl_link; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/youtube.png"  alt=""></a>
                               </div>
                             </div>
                            ...
                            <div class="search_block" >
                              <a href="javascript:void(0)"><img src="<?php echo get_template_directory_uri(); ?>/images/search_icon.png"   alt=""></a>
                            </div>
                          </div>
                  ...
                  <div class="container">
                   <div id="navbar" class="collapse navbar-collapse">
                     <?php uberMenu_easyIntegrate(); ?></div>
                   </div>
                   <!-- search_block_hidden -->
         	...
         	<!--div class="stickry_header_warp">
            	<div class="container">
                	<div class="logo">
                    	<a href="#"><img src="<?php echo ot_get_option('logo'); ?>"   alt=""></a>
                    </div>
                    <div class="navigaction_block">
                      	<div class="navi">
