								...
								<div class="row">
									...
									<div class="col-md-4 actus_block_desktop">
										<div class="actus_box_second third">
											...
											<div class="actus_box_Sub">
												 <div class="details_box">
													<div class="icon_row"><img src="<?php echo get_template_directory_uri(); ?>/images/salon_icon2.png"   alt="">   Course en ligne</div>
													<h3><?php the_title(); ?></h3>
												 </div>
												  <div class="date"><span><?php echo get_the_date('d'); ?></span><?php echo get_the_date('M'); ?></div>
											</div>
									...
									<div class="col-md-4 actus_block_desktop">
											<div class="actus_box_second">
												...
												<div class="actus_box_Sub">
													 <div class="details_box">
													 <div class="icon_row"><img src="<?php echo get_template_directory_uri(); ?>/images/salon_icon.png"   alt="">   Course en ligne</div>
													 <h3><?php the_title(); ?></h3>
												 </div>
													  <div class="date"><span><?php echo get_the_date('d'); ?></span><?php echo get_the_date('M'); ?></div>
												</div>
						 ...
						 <!-- item -->
                        	<div class="item">
                            	...
                            	<div class="actus_box">
                                    ...
                                    <div class="actus_box_Sub">
                                    	 <div class="details_box">
                                         	<div class="icon_row"><img src="<?php get_template_directory_uri(); ?>/images/salon_icon.png"   alt="">  Slalom</div>
                                            <h3><?php the_title(); ?></h3>
                                            <p><?php the_excerpt(); ?></p>
                                            <div class="plue_link">
                                            	<a href="<?php the_permalink(); ?>">
                                                                    	...
                                                                    	<div class="hover_div second">
                                                                        	<div class="big_title">
                                                                                ...
                                                                                <div class="big_social">
                                                                                    ...
                                                                                    <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/facebook.png"></a>
                                                                                    <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/twitter.png"></a>
                                                                                    <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/instagram.png"></a>
                                                                                    <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/youtube.png"></a>
                                                                                </div>
                                                                          </div>
