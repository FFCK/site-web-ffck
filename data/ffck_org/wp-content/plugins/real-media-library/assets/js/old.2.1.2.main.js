...
jQuery(document).ready(function($) {
    ...
    if ($("body").hasClass("wp-admin")
        ...
        /**
         * Handler for clicking the button to create a new collection.
         */
        $(document).on("click", "#rml-add-new-collection", function(e) {
            rmlPrepareAddForm(1);
            e.preventDefault();
        });
        
        /**
         * Handler for clicking the button to create a new gallery.
         */
        $(document).on("click", "#rml-add-new-gallery", function(e) {
            rmlPrepareAddForm(2);
            e.preventDefault();
        });
        ...
        $( '.rml-root-list a' ).droppable({
            ...
            accept: function() {
                ...
                if ($(this).attr("data-type") == "2") {
                    //@TODO
                    // Hochladen restrikten
                    // Move von Dateien restrikten
                    // Sort restrikten
                }
